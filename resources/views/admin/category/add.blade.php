...
<div class="toolbar" id="kt_toolbar">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								...
								action="{{url('/category/store/')}}" method="post" enctype="multipart/form-data">
									@csrf
									<!--begin::Aside column-->
									...
									<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<input type="hidden" name="description" id="divContentInput">
													<!--end::Editor-->
													<!--begin::Description-->
...
<script>
   		 ...
   		 document.getElementById('kt_ecommerce_add_category_form').addEventListener('submit', function(event) 
   		 {
