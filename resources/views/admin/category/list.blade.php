												...
												<tr>
													...
													<td>
														<div class="d-flex">
															...
															<div class="ms-5">
																<!--begin::Title-->
																<a href="{{url('/category/edit/'.$category->id)}}" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$category->name}}</a>
																<!--end::Title-->
																<!--begin::Description-->
																<!-- <div class="text-muted fs-7 fw-bolder">
																	{{Str::limit($category->description,25)}}</div> -->
																<!--end::Description-->
															</div>
														</div>
													</td>
													...
													<td>
														<!--begin::Badges-->
														<a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bolder mb-1" data-kt-ecommerce-category-filter="category_name">{{$category->child_category}}</a>
													...
													<td class="text-end">
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="{{url('/category/edit/'.$category->id)}}" class="menu-link px-3">Edit</a>
															</div>
															<!--end::Menu item-->
															<!--begin::Menu item-->
															<div class="menu-item px-3">
																<a href="{{url('/category/delete/'.$category->id)}}" class="menu-link px-3" >Delete</a>
															</div>
															<!--end::Menu item-->
														</div>
														<!--end::Menu-->
