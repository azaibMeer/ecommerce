...
<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								<!--begin::Form-->
								<form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="post" action="{{url('/product/store')}}" enctype="multipart/form-data">
									@csrf
									<!--begin::Aside column-->
									<div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
										...
										<div class="card card-flush py-4">
											...
											<div class="card-body pt-0">
												...
												<!--end::Select2-->
												<!--begin::Description-->
												<div class="text-muted fs-7 mb-7">Select the category </div>
												<!--end::Description-->
												<!--end::Input group-->
												<!--begin::Button-->
												...
												<!--end::Label-->
												<!--begin::Input-->
												<input id="kt_ecommerce_add_product_tags" name="product_tag" class="form-control mb-2"  />
												<!--end::Input-->
												<!--begin::Description-->
													...
													<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="mb-10 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="short_description" class="form-control mb-2" placeholder="Short description" value="" />
																<!--end::Input-->
																<!--begin::Description-->
															...
															<div>
																...
																<input type="hidden" name="long_description" id="divContentInput">
																<!--end::Editor-->
																<!--begin::Description-->
													...
													<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="mb-10 fv-row">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" name="product_sku" class="form-control mb-2" placeholder="SKU Number" value="" />
																<!--end::Input-->
																<!--begin::Description-->
													...
													<div class="card card-flush py-4">
														...
														<div class="card-body pt-0">
															...
															<div class="mb-10">
																...
																<textarea class="form-control min-h-100px mb-2" name="meta_description" >
															...
															<div>
																...
																<!--end::Label-->
																<!--begin::Editor-->
																<input id="kt_ecommerce_add_product_meta_keywords" name="meta_tags" class="form-control mb-2" />
																<!--end::Editor-->
																<!--begin::Description-->
...
<script src="{{url('/backend_assets/js/custom/apps/ecommerce/catalog/save-product.js')}}"></script>
...
<script>
         ...
         document.getElementById('divContentInput').value = content;
         this.submit();
