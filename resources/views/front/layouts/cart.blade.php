...
@section('class', 'product-cart checkout-cart blog')
@section('content')
                ...
                <div class="cart-container">
                  <div class="cart-overview js-cart">
                    <ul class="cart-items">
                      ...
                      <li class="cart-item">
                        <div class="product-line-grid row justify-content-between">
                          ...
                          <div class="product-line-grid-left col-md-2">
                            ...
                            <img class="img-fluid" src="{{$item->main_image}}" alt="Organic Strawberry Fruits">
                            </a>
                            </span>
                          </div>
                          <div class="product-line-grid-body col-md-6">
                            <div class="product-line-info">
                              <a class="label" href="product-detail.html" data-id_customization="0">{{Str::limit($item->name,100)}}</a>
                            </div>
                            <div class="product-line-info product-price">
                              <span class="value">{{$setting->currency}} {{$item->price / $item->quantity}}</span>
                            </div>
                            <!-- <div class="product-line-info">
                          ...
                          <div class="product-line-grid-right text-center product-line-actions col-md-4">
                            <div class="row">
                              <div class="col-md-5 col qty">
                                ...
                                <div class="quantity">
                                  <input type="text" name="qty" value="{{$item->quantity}}" class="input-group form-control">
                              ...
                              <div class="col-md-2 col text-xs-right align-self-end">
                                <div class="cart-line-product-actions ">
                                  <a class="remove-from-cart" rel="nofollow" href="{{url('/remove/cart/product/'.$item->id)}}" data-link-action="delete-from-cart" data-id-product="1">
                      ...
                      @endforeach
                      @else
                        <span>There Have No Product In Your Cart</span>
                      @endif
                    </ul>
                  </div>
                </div>
                <a href="{{url('/')}}" class="continue btn btn-primary pull-xs-right">
                Continue
                </a>
                ...
                <div class="cart-summary">
                  <div class="cart-detailed-totals">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        @if(count($items) > 0)
                        <a class="btn btn-info btn-sm" href="{{url('/user/checkout')}}">
