...
<head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="/front_assets/libs/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/front_assets/libs/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="/front_assets/libs/font-material/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" href="/front_assets/libs/nivo-slider/css/nivo-slider.css">
    <link rel="stylesheet" href="/front_assets/libs/nivo-slider/css/animate.css">
    <link rel="stylesheet" href="/front_assets/libs/nivo-slider/css/style.css">
    <link rel="stylesheet" href="/front_assets/libs/owl-carousel/assets/owl.carousel.min.css">
...
<body id="@yield('id', 'home')" class="@yield('class', '')">
                                        ...
                                        <tr>
                                            <td class="product-image">
                                                <a href="product-detail.html">
                                                    <img src="/front_assets/img/product/5.jpg" alt="Product">
                                                </a>
                                            </td>
                                            <td>
                    ...
                    <ul class="menu level1">
                        <li class="item  parent">
                            <a href="#" class="hasicon" title="SIDE TABLE">
                                <img src="/front_assets/img/home/table-lamp.png" alt="img">SIDE TABLE</a>
                        ...
                        <li class="item  parent group">
                            <a href="#" class="hasicon" title="FI">
                                <img src="/front_assets/img/home/fireplace.png" alt="img">FIREPLACE
                            </a>
                        ...
                        <li class="item group-category-img parent group">
                            <a href="#" class="hasicon" title="TABLE LAMP">
                                <img src="/front_assets/img/home/table-lamp.png" alt="img">TABLE LAMP</a>
                        ...
                        <li class="item">
                            <a href="#" class="hasicon" title="OTTOMAN">
                                <img src="/front_assets/img/home/ottoman.png" alt="img">OTTOMAN
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="ARMCHAIR">
                                <img src="/front_assets/img/home/armchair.png" alt="img">ARMCHAIR
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="CUSHION">
                                <img src="/front_assets/img/home/cushion.png" alt="img">CUSHION
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="COFFEE TABLE">
                                <img src="/front_assets/img/home/coffee_table.png" alt="img">COFFEE TABLE</a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="SHELF">
                                <img src="/front_assets/img/home/shelf.png" alt="img">SHELF
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="SOFA">
                                <img src="/front_assets/img/home/sofa.png" alt="img">SOFA
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="DRESSING TABLE">
                                <img src="/front_assets/img/home/dressing.png" alt="img">DRESSING TABLE</a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="WINDOWN CURTAIN">
                                <img src="/front_assets/img/home/windown.png" alt="img">WINDOWN CURTAIN</a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="CHANDELIER">
                                <img src="/front_assets/img/home/chandelier.png" alt="img">CHANDELIER
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="CEILING FAN">
                                <img src="/front_assets/img/home/ceiling_fan.png" alt="img">CEILING FAN</a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="WARDROBE">
                                <img src="/front_assets/img/home/wardrobe.png" alt="img">WARDROBE
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="FLOOR LAMP">
                                <img src="/front_assets/img/home/floor_lamp.png" alt="img">FLOOR LAMP</a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="VASE-FLOWER ">
                                <img src="/front_assets/img/home/vase-flower.png" alt="img">VASE-FLOWER
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="BED">
                                <img src="/front_assets/img/home/bed.png" alt="img">BED
                            </a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="BED GIRL">
                                <img src="/front_assets/img/home/bed.png" alt="img">BED GIRL</a>
                        </li>
                        <li class="item">
                            <a href="#" class="hasicon" title="BED BOY">
                                <img src="/front_assets/img/home/bed.png" alt="img">BED BOY</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script src="/front_assets/libs/popper/popper.min.js"></script>
    <script src="/front_assets/libs/bootstrap/js/bootstrap.min.js"></script>
    <script src="/front_assets/libs/nivo-slider/js/jquery.nivo.slider.js"></script>
    <script src="/front_assets/libs/owl-carousel/owl.carousel.min.js"></script>
